...
#### Technical & Logic > Amount

`Range input (float)`
`Range: 0-10000`
`Default: 0`

#### Technical & Logic > Method
...
#### Technical & Logic > Closeable

`Toggle switch`
`Default: OFF`

#### Technical & Logic > Starts Hidden

`Toggle switch`
`Default: OFF`

#### Technical & Logic > No Popup

`Toggle switch`
`Default: OFF`

#### Technical & Logic > Custom Message
